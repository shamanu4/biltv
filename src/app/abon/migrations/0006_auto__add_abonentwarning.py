...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AbonentWarning'
        db.create_table('abon_abonentwarning', (
        ...
        db.send_create_signal('abon', ['AbonentWarning'])


    def backwards(self, orm):
        # Deleting model 'AbonentWarning'
        db.delete_table('abon_abonentwarning')
    ...
    models = {
        ...
        'abon.abonentwarning': {
            'Meta': {'object_name': 'AbonentWarning'},
        ...
        'abon.person': {
            ...
            'phone': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'blank': 'True'}),
            'registration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 4, 0, 0)'}),
