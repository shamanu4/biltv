...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Illegal'
        db.create_table('abon_illegal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('abon', ['Illegal'])


    def backwards(self, orm):
        # Deleting model 'Illegal'
        db.delete_table('abon_illegal')
