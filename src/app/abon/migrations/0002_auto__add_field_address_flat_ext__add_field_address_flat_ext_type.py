...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Address.flat_ext'
        db.add_column('abon_address', 'flat_ext',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Address.flat_ext_type'
        db.add_column('abon_address', 'flat_ext_type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Address.flat_ext'
        db.delete_column('abon_address', 'flat_ext')

        # Deleting field 'Address.flat_ext_type'
        db.delete_column('abon_address', 'flat_ext_type')
    ...
    models = {
        ...
        'abon.address': {
            ...
            'flat_ext': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
