...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('abon_person', (
            ...
            ('registration', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 4, 0, 0))),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.create_table('abon_address', (
            ...
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('sorting', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, blank=True)),
            ('override', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=20)),
        ))
        ...
        # Adding model 'AbillsLink'
        db.create_table('abon_abillslink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('abonent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['abon.Abonent'], unique=True)),
            ('abills', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['abills.User'], unique=True)),
            ('card', self.gf('django.db.models.fields.related.ForeignKey')(related_name='abills_links', unique=True, to=orm['tv.Card'])),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='abills_links', unique=True, to=orm['tv.CardService'])),
        ))
        db.send_create_signal('abon', ['AbillsLink'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AbillsLink'
        db.delete_table('abon_abillslink')
