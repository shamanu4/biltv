...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('abon_address', 'phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Person.phone'
        db.add_column('abon_person', 'phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('abon_address', 'phone')

        # Deleting field 'Person.phone'
        db.delete_column('abon_person', 'phone')
    ...
    models = {
        ...
        'abon.person': {
            ...
            'phone': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'blank': 'True'}),
            'registration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 10, 0, 0)'}),
