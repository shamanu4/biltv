...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Abonent', fields ['extid']
        db.delete_unique('abon_abonent', ['extid'])


        # Changing field 'Address.flat_ext'
        db.alter_column('abon_address', 'flat_ext', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Address.flat_ext'
        db.alter_column('abon_address', 'flat_ext', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
        # Adding unique constraint on 'Abonent', fields ['extid']
        db.create_unique('abon_abonent', ['extid'])
