...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bill.balance2'
        db.add_column('abon_bill', 'balance2',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bill.balance2'
        db.delete_column('abon_bill', 'balance2')
    ...
    models = {
        ...
        'abon.person': {
            ...
            'phone': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'blank': 'True'}),
            'registration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 21, 0, 0)'}),
