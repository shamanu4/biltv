...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.passport'
        db.alter_column('data_person', 'passport', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Person.passport'
        raise RuntimeError("Cannot reverse this migration. 'Person.passport' and its values cannot be restored.")
    ...
    models = {
        ...
        'data.person': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'passport': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'})
        },
        'data.proplata': {
