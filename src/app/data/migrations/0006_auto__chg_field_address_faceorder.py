...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Address.faceorder'
        db.alter_column('data_address', 'faceorder', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Address.faceorder'
        db.alter_column('data_address', 'faceorder', self.gf('django.db.models.fields.CharField')(max_length=13, null=True))
