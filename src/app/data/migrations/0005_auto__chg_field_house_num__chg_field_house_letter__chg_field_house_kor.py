...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'House.num'
        db.alter_column('data_house', 'num', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'House.letter'
        db.alter_column('data_house', 'letter', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

        # Changing field 'House.korp'
        db.alter_column('data_house', 'korp', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'House.num'
        raise RuntimeError("Cannot reverse this migration. 'House.num' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'House.letter'
        raise RuntimeError("Cannot reverse this migration. 'House.letter' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'House.korp'
        raise RuntimeError("Cannot reverse this migration. 'House.korp' and its values cannot be restored.")
