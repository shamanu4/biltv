...
Ext.ux.warning_store = new Ext.data.DirectStore({
    api: {
        read: AbonWarningGrid.read,
        create: AbonWarningGrid.foo,
        update: AbonWarningGrid.foo,
        destroy: AbonWarningGrid.foo
    },
    restful: true,
    autoLoad: true,
    autoSave: false,
...
var warning_ds_model = Ext.data.Record.create([
			'id',
			'code',
            'date',
            'level',
